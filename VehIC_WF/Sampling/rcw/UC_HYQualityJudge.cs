...
{
    public partial class UC_HYQualityJudge : UserControl
    {
        public UC_HYQualityJudge()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            ...
            //else if(FrmMain.localinfo.workpoint.Code=="0076")
                mixSamples.LoadDataByWhere(string.Format("main.SampleState>={0} and main.SampleState<{1} and main.WLLX='火运' order by main.ZyRecvTime,main.mix_time", (int)SampleState.开始制样, (int)SampleState.NC报检完成));
                zdpdmixSamples.LoadDataByWhere(string.Format("main.SampleState>={0} and main.SampleState<{1} and main.WLLX='火运' and main.mix_time>'{2}' order by main.ZyRecvTime,main.mix_time", (int)SampleState.化验审核完成, (int)SampleState.NC报检完成, DateTime.Now.AddDays(-4).ToString("yyyy-MM-dd HH:mm:ss")));
        ...
        private void 查询ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                if (dlg.WhereSql != "")
                {
                    mixSamples.LoadDataByWhere(dlg.WhereSql + "and main.wllx='火运'");
                }
            }
        }
        /// <summary>
