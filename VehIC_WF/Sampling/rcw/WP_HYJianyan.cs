...
{
    public partial class WP_HYJianyan : UserControl, ICardMessage
    {
        ...
        public void HandleCardMessage(Device.CardReader device, string cardId)
        {
            ...
            labTable1.LoadDataByWhere("labstate='送检' and checkgroupname like '化验样%' and  maketime>=@maketime and main.WLLX='火运'", DateTime.Today.AddDays(-1));
          //  labTable2.LoadDataByWhere("labstate='送检' and checkgroupname like '角质层%' and  maketime>=@maketime", DateTime.Today.AddDays(-1));
            label2.Text = labTable1.Count.ToString();
         //   label4.Text = labTable2.Count.ToString();
            SetGridViewFocuse();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            lableiji.LoadInfo = "CheckVals";
            this.qCSampleLabBindingSource.DataSource = lableiji;
            lableiji.LoadDataByWhere("main.BillType=@BillType and main.WLLX='火运' order by JyTime desc", "开始检验");
            labTable1.LoadDataByWhere("main.labstate='送检' and main.checkgroupname like '化验样%' and  main.maketime>=@maketime and main.WLLX='火运'", DateTime.Today.AddDays(-1));
            //labTable2.LoadDataByWhere("labstate='送检' and checkgroupname like '角质层%' and  maketime>=@maketime", DateTime.Today.AddDays(-1));
