...
{
    public partial class UC_RJQualityJudge : UserControl
    {
        public UC_RJQualityJudge()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
           ...
           mixSamples.LoadDataByWhere(string.Format("main.SampleState>={0} and main.SampleState<{1} and main.WLLX='熔剂' order by main.ZyRecvTime,main.mix_time", (int)SampleState.开始制样, (int)SampleState.NC报检完成));
           zdpdmixSamples.LoadDataByWhere(string.Format("main.SampleState>={0} and main.SampleState<{1} and main.WLLX='熔剂' and main.mix_time>'{2}' order by main.ZyRecvTime,main.mix_time", (int)SampleState.化验审核完成, (int)SampleState.NC报检完成, DateTime.Now.AddDays(-4).ToString("yyyy-MM-dd HH:mm:ss")));  
        ...
        private void 查询ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                if (dlg.WhereSql != "")
                {
                    mixSamples.LoadDataByWhere(dlg.WhereSql + "and main.wllx='熔剂'");
                }
            }
        }
        /// <summary>
