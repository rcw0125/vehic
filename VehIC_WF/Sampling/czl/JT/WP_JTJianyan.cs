...
{
    public partial class WP_JTJianyan : UserControl, ICardMessage
    {
        ...
        private void WP_Jianyan_Load(object sender, EventArgs e)
        {
            ...
            lableiji.LoadDataByWhere("main.BillType=@BillType and main.WLLX='焦炭' order by main.JyTime desc", "开始检验");
            labTable1.LoadDataByWhere("main.labstate='焦炭' and main.checkgroupname like '化验样%' and  main.maketime>=@maketime and main.WLLX='焦炭'", DateTime.Today.AddDays(-1));
        ...
        public void HandleCardMessage(Device.CardReader device, string cardId)
        {
            ...
            if (tempLab.WLLX != "焦炭") { MessageBox.Show("此样品不是焦炭"); return; }
            ...
            labTable1.LoadDataByWhere("labstate='送检' and checkgroupname like '化验样%' and  maketime>=@maketime and WLLX='焦炭'", DateTime.Today.AddDays(-1));
          //  labTable2.LoadDataByWhere("labstate='送检' and checkgroupname like '角质层%' and  maketime>=@maketime", DateTime.Today.AddDays(-1));
            label2.Text = labTable1.Count.ToString();
         //   label4.Text = labTable2.Count.ToString();
            SetGridViewFocuse();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            labTable1.LoadDataByWhere("main.labstate='送检' and main.checkgroupname like '化验样%' and  main.maketime>=@maketime and main.WLLX='焦炭'", DateTime.Today.AddDays(-1));
            //labTable2.LoadDataByWhere("labstate='送检' and checkgroupname like '角质层%' and  maketime>=@maketime", DateTime.Today.AddDays(-1));
