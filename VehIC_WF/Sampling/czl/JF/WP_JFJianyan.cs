...
{
    public partial class WP_JFJianyan : UserControl, ICardMessage
    {
        ...
        private void WP_Jianyan_Load(object sender, EventArgs e)
        {
            ...
            lableiji.LoadDataByWhere("main.BillType=@BillType and main.WLLX='精粉' order by JyTime desc", "开始检验");
            labTable1.LoadDataByWhere("main.labstate='送检' and main.checkgroupname like '化验样%' and  main.maketime>=@maketime and main.WLLX='精粉'", DateTime.Today.AddDays(-1));
        ...
        public void HandleCardMessage(Device.CardReader device, string cardId)
        {
            ...
            if (tempLab.WLLX != "精粉") { MessageBox.Show("此样品不是精粉"); return; }
            tempLab.JyCode = DbContext.GetSeq("FY" + DateTime.Now.Date.ToString("yyyyMMdd"), 2);
