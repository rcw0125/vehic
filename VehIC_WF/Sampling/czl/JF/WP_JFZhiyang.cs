...
{
    public partial class WP_JFZhiyang : UserControl, ICardMessage
    {
        public WP_JFZhiyang()
        {
            InitializeComponent();
        ...
        public void HandleCardMessage(Device.CardReader device, string cardId)
        {
            ...
            if (icCard.CardType == QC_IC_Info.CardUseType_Mix)
            {
                ...
                if (zySample.WLLX != "精粉")
                {
                    MessageBox.Show("物料不是精粉请选择其他制样点");
                    return;
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (zySample != null && zySample.CheckGroups.Count > 0)
            {
                ...
                if (printPage >= 0 && printPage < zySample.CheckGroups.Count)
                {
                    ...
                    if(item.CheckGroupName=="球团物理样")
                     riqiSize = e.Graphics.MeasureString(riqi, f3);
                    ...
                    if (item.CheckGroupName == "球团物理样")
                        e.Graphics.DrawString(riqi, f3, Brushes.Black, new PointF(rect.Left, topMargin3));
                    else e.Graphics.DrawString(riqi, f2, Brushes.Black, new PointF(leftMargin3, topMargin3));
                }
       ...
       // private DbEntityTable<QC_Sample_Lab> jzLabs = new DbEntityTable<QC_Sample_Lab>();
        ...
        private void printDocument2_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            var jzFenZu = from zySample in this.zyMixSamples
                          where zySample.ZyJzZuPiHao.StartsWith("JZ"+DateTime.Today.Day.ToString("00"))
