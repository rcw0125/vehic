...
{
    public partial class WP_Shcx : UserControl
    {
        public WP_Shcx()
        {
            InitializeComponent();
        ...
        private void 查询检验单_Click(object sender, EventArgs e)
        {
            ...
            else if (comboBox2.Text == "全部") lab.LoadDataByWhere("main.JyTime>=@Ksdate and  main.JyTime<=@Jsdate and main.CheckGroupName=@CheckGroupName order by main.JyCode ", DateTime.Parse(this.dateEdit1.Text.Trim()), DateTime.Parse(this.dateEdit2.Text.Trim()), comboBox1.Text);
            else if (comboBox1.Text == "全部") lab.LoadDataByWhere("main.JyTime>=@Ksdate and  main.JyTime<=@Jsdate and main.MatName=@MatName order by main.JyCode ", DateTime.Parse(this.dateEdit1.Text.Trim()), DateTime.Parse(this.dateEdit2.Text.Trim()), comboBox2.Text);
            else lab.LoadDataByWhere("main.JyTime>=@Ksdate and  main.JyTime<=@Jsdate and main.CheckGroupName=@CheckGroupName and main.MatName=@MatName  order by main.JyCode ", DateTime.Parse(this.dateEdit1.Text.Trim()), DateTime.Parse(this.dateEdit2.Text.Trim()), comboBox1.Text, comboBox2.Text);
