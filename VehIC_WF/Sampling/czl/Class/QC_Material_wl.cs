...
namespace VehIC_WF.Sampling.czl.Class
{
    ...
    /// 物料
    /// </summary>
    [DbTable("QC_Material_wl", "main")]
    [DbTable("BD_INVBASDOC", "inv", "inv.PK_INVBASDOC=main.MatNcId", JoinType.Left)]
    public class QC_Material_wl : DbEntity
    {
