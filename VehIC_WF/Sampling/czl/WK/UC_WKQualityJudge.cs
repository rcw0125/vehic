...
{
    public partial class UC_WKQualityJudge : UserControl
    {
        public UC_WKQualityJudge()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
           ...
           mixSamples.LoadDataByWhere(string.Format("main.SampleState>={0} and main.SampleState<{1} and main.WLLX='外矿' order by main.ZyRecvTime,main.mix_time", (int)SampleState.开始制样, (int)SampleState.NC报检完成));
        ...
        private void 查询ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                if (dlg.WhereSql != "")
                {
                    mixSamples.LoadDataByWhere(dlg.WhereSql + "and main.wllx='外矿'");
                }
            }
        }
        /// <summary>
