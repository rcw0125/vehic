...
{
    public partial class WP_WKZhiyang : UserControl, ICardMessage
    {
        public WP_WKZhiyang()
        {
            InitializeComponent();
        ...
        private void WP_Zhiyangdan_Load(object sender, EventArgs e)
        {
            ...
            LabTabs();
            hjmixs.LoadDataByWhere("main.SAMPLESTATE=@SAMPLESTATE and main.WLLX='外矿'", SampleState.组批完成);
        ...
        private void 制样_Click(object sender, EventArgs e)
        {
            ...
            if (!comboBox1.Text.StartsWith("WK"))
            {
            ...
            if (zySample.WLLX != "外矿")
            {
                MessageBox.Show("物料不是外矿请选择其他制样点");
                return;
