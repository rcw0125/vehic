...
{
    public partial class Hunyang : UserControl, ICardMessage
    {
        ...
        public void jsdtgs()
        {
            ...
            cheshucy.LoadDataBySql("select SUPPLIERCODE as cj,MATCODE as wl,WPCODE as dd,COUNT(*) as num from QC_Sample_Veh where sample_mix_id=0 and sample_tbzd=1 and SampleState=@SampleState and WLLX='煤' group by SUPPLIERCODE,MATCODE,WPCODE", SampleState.初始状态);
            ...
            cheshufl.LoadDataBySql("select SUPPLIERCODE as cj,MATCODE as wl,WPCODE as dd,COUNT(*) as num from QC_Sample_Veh where sample_mix_id=0 and (sample_jy is null or sample_jy<>1) and sample_tbzd<>1 and SampleState=@SampleState and WLLX='煤' group by SUPPLIERCODE,MATCODE,WPCODE", SampleState.初始状态);
        ...
        public void jsdtgs1()
        {
            ...
            //组抽样的
            DbEntityTable<cheshu> cheshucy = new DbEntityTable<cheshu>();
            cheshucy.LoadDataBySql("select SUPPLIERCODE as cj,MATCODE as wl,WPCODE as dd,COUNT(*) as num from QC_Sample_Veh where sample_mix_id=0 and sample_tbzd=1 and SampleState=@SampleState and WLLX='煤' group by SUPPLIERCODE,MATCODE,WPCODE", SampleState.开始组批);
            foreach (var x in cheshucy)
            {
            ...
            DbEntityTable<cheshu> cheshufl = new DbEntityTable<cheshu>();
            cheshufl.LoadDataBySql("select SUPPLIERCODE as cj,MATCODE as wl,WPCODE as dd,COUNT(*) as num from QC_Sample_Veh where sample_mix_id=0 and (sample_jy is null or sample_jy<>1) and sample_tbzd<>1 and SampleState=@SampleState and WLLX='煤' group by SUPPLIERCODE,MATCODE,WPCODE", SampleState.开始组批);
            foreach (var x in cheshufl)
            {
                fzcs = 0;
                QC_Material matInfo = QC_Material.GetByCode(x.wl);
        ...
        public void zupi()
        {
            ...
            //组抽样的
            DbEntityTable<cheshu> cheshucy = new DbEntityTable<cheshu>();
            cheshucy.LoadDataBySql("select SUPPLIERCODE as cj,MATCODE as wl,WPCODE as dd  from QC_Sample_Veh where sample_mix_id=0 and sample_tbzd=1 and SampleState=@SampleState and WLLX='煤'", SampleState.开始组批);
            foreach (var x in cheshucy)
            {
                dtmax = 1;
