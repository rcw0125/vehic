...
namespace Xg.Lab.Sample
{
    ...
    [DbTable("QC_Sample_Value","main")]
    public partial class QC_Sample_Value_Pd : DbEntity
    {
        #region 主键
        ...
        /// </summary> 
        [DisplayName("检验项编码")]
        [DbTableColumn("chitem.CheckItemCode", SortDirection = SortDirection.Ascending, SortOrder = 1)]
    ...
    public class QC_Sample_Value_Pd_Table : DbEntityTable<QC_Sample_Value_Pd>, IGetTagValue
    {
